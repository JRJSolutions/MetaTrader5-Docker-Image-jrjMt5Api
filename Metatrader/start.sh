...
mt5file='/config/.wine/drive_c/Program Files/MetaTrader 4/terminal.exe'
...
mt5setup_url="https://download.mql5.com/cdn/web/metaquotes.software.corp/mt4/mt4setup.exe"
